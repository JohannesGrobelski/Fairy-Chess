 ...
 *
 * The calls to {@link #onTick} are synchronized to this object so that
 * one call to {@link #onTick} won't ever occur before the previous
 * callback is complete.  This is only relevant when the implementation of
 * {@link #onTick} takes an amount of time to execute that is significant
...
public abstract class CountDownTimerWithPause {
     ...
     */
    public CountDownTimerWithPause(long millisInFuture, long countDownInterval, boolean runAtStart) {
        mMillisInFuture = millisInFuture;
        mTotalCountdown = millisInFuture;
     ...
     * @return this CountDownTimerWithPause instance
     */
    ...
    public boolean hasBeenStarted() {
        return mPauseTimeRemaining <= mTotalCountdown;
    }
