...
class ChessGameUnitTest {
    ...
    fun simpleCheckmate() {
        ...
        chessBoardNormal.checkMoveAndMove("white", Movement.fromStringToMovement("5_1_5_2"))
        chessBoardNormal.checkMoveAndMove("black", Movement.fromStringToMovement("4_6_4_5"))
        chessBoardNormal.checkMoveAndMove("white", Movement.fromStringToMovement("6_1_6_3"))
        chessBoardNormal.checkMoveAndMove("black", Movement.fromStringToMovement("3_7_7_3"))
        chessBoardNormal.checkMoveAndMove("white", Movement.fromStringToMovement("6_0_7_2"))
        chessBoardNormal.checkMoveAndMove("black", Movement.fromStringToMovement("7_3_4_0"))
